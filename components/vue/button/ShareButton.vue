...
const twitterUrl = computed(() => `https://twitter.com`);
const facebookUrl = computed(() => `https://www.facebook.com`);
...
<template>
  <Transition name="fade" mode="out-in">
    <button type="button" v-if="!isOpen" class="flex items-center gap-2 mt-4 text-sm text-green-500 cursor-pointer"
      @click="isOpen = true">
