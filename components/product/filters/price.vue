    ...
    <div>
        ...
        <div v-show="isOpen" class="mt-3 grid gap-4 grid-cols-2">
            <div class="flex relative items-center">
                <input id="price-from" v-model="price[0]"
            ...
            <div class="flex relative items-center">
                <input id="price-to" v-model="price[1]"
                    class="bg-white border rounded-lg max-w-full border-gray-200 leading-none w-auto p-2 pl-6 md:text-sm"
            ...
            <div class="mx-1 mt-1 col-span-full">
                <Slider v-model="price" :tooltips="false" :lazy="false" :min="0" :max="maxPrice"
                    ariaLabelledby="price-from price-to" @change="applyPrice" />
            </div>
        </div>
    </div>
</template>
